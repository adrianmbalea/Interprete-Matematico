...
#REGLA 3: Compila con -lfl
lex.yy.o: lex.yy.o.c $(LIB_HEADERS)
	$(CC) -c -o $@ $< $(INCLUDES) -lfl
	
# REGLA 4: borra el ejecutable (prerrequisito: clean)
cleanall: clean
	rm   -f $(OUTPUT) 

# REGLA 5: borra los ficheros .o y los de backup (terminan en ~)
clean:
	rm -f ./src/*.o
